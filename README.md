...
```
Fast cooling reduces the temperature quickly and the algorithm converges faster but may miss better solutions. 
Slow cooling allows the algorithm to explore more possibilities and often finds better timetables. 
Therefore slower cooling generally produces fewer clashes and better optimization results.
```
